...
// Notes:
// - This program is the same as the version in Chapter 7 except it adds the
...
namespace Sorting
{
    public partial class Form1 : Form
    {
        ...
        private void runButton_Click(object sender, EventArgs e)
        {
            ...
            if (nonrecursiveQuicksortCheckBox.Checked)
                RunAlgorithm(maxSeconds, Sorts<int>.Quicksort2, nonrecursiveQuicksortTextBox);
        ...
        private void ClearResults()
        {
            ...
            nonrecursiveQuicksortTextBox.Clear();
